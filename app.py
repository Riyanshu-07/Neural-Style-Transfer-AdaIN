...
from utils.utils import adaptive_instance_normalization, cal_mean_std
...
decoder_path = "pretrained_decoder.pth" if os.path.exists("pretrained_decoder.pth") else "experiment/experiment3/decoder_epoch_10.pth"
raw_state = torch.load(decoder_path, map_location=device)
state = {'net.' + k if not k.startswith('net.') else k: v for k, v in raw_state.items()}
